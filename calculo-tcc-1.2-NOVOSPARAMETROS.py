...
plt.legend()
#plt.savefig('/home/zh3ro/CORE/biblioteca/16. python/tcc/updateCurvas/imagens/caso 1.2/Figura1.eps', format='eps')
...
plt.tight_layout(pad=1)
plt.legend()
#plt.savefig('/home/zh3ro/CORE/biblioteca/16. python/tcc/updateCurvas/imagens/caso 1.2/Figura2.eps', format='eps')
...
plt.tight_layout(pad=1)
plt.legend()
#plt.savefig('/home/zh3ro/CORE/biblioteca/16. python/tcc/updateCurvas/imagens/caso 1.2/Figura3.eps', format='eps')
